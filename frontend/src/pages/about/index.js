    ...
    <Container>
      ...
      <div className={styles.content}>
        ...
        <aside>
          ...
          <div className={styles.text}>
            <p className={styles.textItem}>
              Код проекта находится тут - <a href="#" className={styles.textLink}>https://github.com/mrSoftice/foodgram</a>
            </p>
            <p className={styles.textItem}>
              Автор проекта: <a href="https://github.com/mrSoftice" className={styles.textLink}>Гончаренко Денис</a>
            </p>
          </div>
        </aside>
      </div>
